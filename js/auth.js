...
----------------------------------------------------- */
async function createUserProfile({ uid, name, email, role, studentId, rollNumber, className, section, childStudentId }) {
...
----------------------------------------------------- */
export async function signUpStudentOrParent({ name, email, password, role, studentId, rollNumber, className, section, childStudentId }) {
...
export async function completeGoogleProfile({ uid, name, email, role, studentId, rollNumber, className, section, childStudentId }) {
  await createUserProfile({
    uid: uid,
    name: name,
    email: email,
