...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function initAppointmentPage(user, profile) {
    ...
    /* -----------------------------------------------------
       STAFF VIEW — this page is for parents to book;
       staff manage requests from the Staff Dashboard instead.
    ----------------------------------------------------- */
    if (profile.role === 'staff') {
      document.querySelector('.search-card').innerHTML =
        '<div class="info-note-box info">' +
          '<span class="info-note-icon">ℹ️</span>' +
          '<span>This page is for parents to request an appointment. To review and approve/reject ' +
          'appointment requests, use the <a href="staff-dashboard.html">Staff Dashboard → Appointments</a> panel.</span>' +
        '</div>';
      return;
    }
